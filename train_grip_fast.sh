#!/bin/bash
#SBATCH --job-name=train_armframe_rq
...
DATA="$HF_LEROBOT_HOME/cotrain_dualarm4/meta/info.json"
NORM="assets/$CONFIG/cotrain_dualarm4/norm_stats.json"
CKPT_DIR="checkpoints/$CONFIG/armframe_v2"
